      ...
      <div className="bg-white rounded-2xl max-w-md w-full">
        <div className="bg-gradient-to-b from-[#0c1015] to-[#1f2038] rounded-t-2xl flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <h2 className="ml-3 text-xl font-bold text-transparent bg-clip-text bg-gradient-to-tl from-[#ff3f3f] to-[#ff4b87]">Confirm Deletion</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              disabled={loading}
              className="flex-1 px-4 py-2 bg-gradient-to-tl from-[#da0000] to-[#ff4b87] text-white rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center"
            >
              {loading ? (
                <>
