...
const LoginPagePeserta: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-t from-[#47618a] to-[#E3E1DA] text-white p-4">
      ...
      >
        {[
          { class: "absolute bottom-[10%] left-[0%] w-[22%]", depth: 60, src: "/svg/blocks/block w m.svg" },
          { class: "absolute bottom-[-10%] left-[-6%] w-[18%]", depth: 80, src: "/svg/blocks/block w m.svg" },
          { class: "absolute bottom-[-5%] left-[15%] w-[14%]", depth: 90, src: "/svg/blocks/block w m.svg" },
          { class: "absolute bottom-[-20%] left-[5%] w-[15%]", depth: 120, src: "/svg/blocks/block w main.svg" },
        ].map((item, i) => (
          <motion.img
            key={i}
            src={item.src}
            className={`${item.class} opacity-100`}
            initial={{ y: item.depth, opacity: 0 }}
        ...
        {[
          { class: "absolute bottom-[10%] right-[0%] w-[22%]", depth: 60, src: "/svg/blocks/block b m.svg" },
          { class: "absolute bottom-[-10%] right-[-6%] w-[18%]", depth: 80, src: "/svg/blocks/block b m.svg" },
          { class: "absolute bottom-[-5%] right-[15%] w-[14%]", depth: 90, src: "/svg/blocks/block b m.svg" },
          { class: "absolute bottom-[-20%] right-[5%] w-[15%]", depth: 120, src: "/svg/blocks/block-b-main.svg" },
        ].map((item, i) => (
          <motion.img
            key={`r-${i}`}
            src={item.src}
