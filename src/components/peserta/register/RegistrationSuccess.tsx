      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-md text-center">
          ...
          <p className="text-gray-600">
            Kami telah mengirimkan email verifikasi ke alamat email Anda. Silakan periksa inbox Anda dan klik tautan verifikasi untuk mengaktifkan akun Anda. Pastikan cek email yang terbaru ketika click resend email. Jika link verifikasi tidak muncul, click "show quoted text" atau "tampilkan kutipan teks"
          </p>
          ...
          <div className="pt-6">
            <button
              onClick={() => navigate('/peserta/login')}
...
export default RegistrationSuccessPeserta;