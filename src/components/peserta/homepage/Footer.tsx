...
export default function Footer() {
  return (
    <footer className="relative z-50">
      <div className="bg-gradient-to-tr md:bg-gradient-to-l from-[#47618a] to-[#E3E1DA] md:via-[#E3E1DA] md:to-[#47618a]">
          ...
          <div className="grid grid-cols-1 items-center gap-8 text-center md:grid-cols-[1fr_auto_1fr] md:gap-12 md:text-left">
            ...
            <div className="flex justify-center md:justify-end">
              <a href="/" className="flex items-center gap-4 group">
                ...
                />
                <div className="font-spekk tracking-tight flex items-center text-2xl md:text-3xl">
                  <span className="font-bold text-[#0f1028]">UKM</span>
                  <span className="text-yellow-500 mx-2">|</span>
                  <span className="text-[#0f1028]">CATUR</span>
                </div>
              </a>
            </div>
            ...
            <div className="flex justify-center md:justify-start">
              <div className="flex flex-col items-center gap-6 font-semibold md:items-start">
                ...
                <a
                  ...
                  className="group flex items-center gap-3 px-4 py-3 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  <div className="bg-[#0f1028] p-2 rounded-full">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[#0f1028] font-bold group-hover:text-[#0f1028] transition-colors">
                      Report bug here
                    </p>
                  </div>
                </a>
