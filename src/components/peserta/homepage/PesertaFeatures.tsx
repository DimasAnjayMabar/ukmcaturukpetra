        ...
        <div className="relative w-full h-[65vh] md:h-[50vh]">
          <div className="absolute inset-0 block">
            ...
            <div className="absolute inset-0 transform-gpu origin-bottom scale-[1.4] md:scale-[0.85]">
              ...
              <img src="/svg/blocks/block b m.svg" alt="Decoration" className="absolute w-[24%] z-40 bottom-[20%] sm:bottom-[-63%] md:bottom-[20%] xl:bottom-[-70%] left-[50%]" />
              <img src="/svg/blocks/block w m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[0%] xl:bottom-[-90%] left-[14%]" />
              <img src="/svg/blocks/block w m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[0%] xl:bottom-[-90%] left-[62%]" />
              <img src="/svg/blocks/block b m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[-10%] xl:bottom-[-110%] left-[26%]" />
              <img src="/svg/blocks/block b m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[-10%] xl:bottom-[-110%] left-[50%]" />
              <img src="/svg/blocks/block b m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-40 bottom-[15%] xl:bottom-[-70%] left-[2%]" />
              <img src="/svg/blocks/block b m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-40 bottom-[15%] xl:bottom-[-70%] left-[74%]" />
              <img src="/svg/blocks/block b m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[-15%] xl:bottom-[-110%] left-[2%]" />
              <img src="/svg/blocks/block b m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[-15%] xl:bottom-[-110%] left-[74%]" />
              <img src="/svg/blocks/block w m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[-25%] xl:bottom-[-130%] left-[38%]" />
              <img src="/svg/blocks/block w m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[-25%] xl:bottom-[-130%] left-[14%]" />
              <img src="/svg/blocks/block w m.svg" alt="Decoration" className="sm:hidden md:block absolute w-[24%] z-50 bottom-[-25%] xl:bottom-[-130%] left-[62%]" />
              
              <Link
                to={featureData.scoreboard.path}
                className="group absolute w-[25%] z-10 cursor-pointer bottom-[50%] sm:bottom-[-25%] md:bottom-[50%] xl:bottom-[-10%] left-[37.5%]"
              >
              ...
              <Link
                ...
                className="group absolute w-[24%] z-30 cursor-pointer bottom-[30%] sm:bottom-[-50%] md:bottom-[30%] xl:bottom-[-50.25%] left-[14%]"
              >
                <div className="relative transition-transform duration-300 ease-out group-hover:-translate-y-4">
                  <div className="absolute -top-8 sm:-top-12 md:-top-8 xl:-top-12 left-1/2 transform -translate-x-1/2 z-50">
                    <div className="bg-white/70 backdrop-blur-sm px-2 md:px-3 py-0.5 md:py-1 rounded-full shadow-lg">
              ...
              <Link
                ...
                className="group absolute w-[24%] z-30 cursor-pointer bottom-[30%] sm:bottom-[-50%] md:bottom-[30%] xl:bottom-[-50.5%] left-[62%]"
              >
                <div className="relative transition-transform duration-300 ease-out group-hover:-translate-y-4">
                  <div className="absolute -top-8 sm:-top-12 md:-top-8 xl:-top-12 left-1/2 transform -translate-x-1/2 z-50">
                    <div className="bg-white/70 backdrop-blur-sm px-2 md:px-3 py-0.5 md:py-1 rounded-full shadow-lg">
              ...
              <button
                ...
                className="group absolute w-[24%] z-40 cursor-pointer bottom-[10%] sm:bottom-[-76%] md:bottom-[10%] xl:bottom-[-90.5%] left-[38%]"
              >
                <div className="relative transition-transform duration-300 ease-out group-hover:-translate-y-4">
                  <div className="absolute -top-8 sm:-top-12 md:-top-8 xl:-top-12 left-1/2 transform -translate-x-1/2 z-50">
                    <div className="bg-white/70 backdrop-blur-sm px-2 md:px-3 py-0.5 md:py-1 rounded-full shadow-lg">
