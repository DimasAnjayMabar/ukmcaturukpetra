...
import { Home, Calendar, Eye, Compass, Book } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <main className="relative">
      ...
      {/* UI untuk user yang login - hanya PesertaFeatures */}
      {isLoggedIn && userProfile ? (
        ...
        /* UI untuk user yang tidak login - semua section normal */
        <>
          <section
            id="hero"
...
/* code awal disini ya, jaga2 kalau mau dikembalikan ke awal :
